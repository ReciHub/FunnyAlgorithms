...
//this algorithm sorts the elements of a linked list
//In this algorithm we implement merge sort so time complexity becomes O(nLogn)
//we make a temporary linked list for the algorithm so the maximum space complexity can be O(n)
