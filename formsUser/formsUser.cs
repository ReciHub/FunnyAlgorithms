...
public class Program
{
	public static void Main()
	{
        ...
        Console.Write("Hello, welcome to the user form.");
        Console.Write("Here, we try to understand through your data, which company suits you.");
        Console.WriteLine("Now can you tell me what your name is?");

        string name = Console.ReadLine();

        //body

        Console.Write("First we would like to know, do you prefer the color black or yellow? Believe me, this is extremely important.");
