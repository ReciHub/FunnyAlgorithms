...
def FCFS(m_process, data):
  ...
  print("P1","Start Time: ",data[0][0],"End Time: ",data[0][0]+data[0][1],"TR : ",tr, "WT : ",wt)
  for i in range(1,n_process):
    ...
    ttr += tr  
    ttw += wt  
    print(process_name,"Start Time: ",start_time,"End Time: ",end_time, "TR : ",tr, "WT : ",wt )
    prev = end_time
...
if __name__ == "__main__":
    ...
    for _ in range(n_process):
        arrival_time,service_time,priority= map(int,input("Arrival | Service | Priority").split())
